...
COPY --chown=10001:10001 app.py store.py postgres_store.py postgres_erp_schema.py identity.py extra_packs.py accounting.py accounting_schema.py retail.py retail_schema.py operational_profile.py onboarding.py onboarding_schema.py operating_model.py operating_model_schema.py rbac.py tax_engine.py branding.py business_twin.py static.html static.css static.js interview.html interview.js retail.html accounting.html accounting.js LICENSE ./
USER 10001:10001
VOLUME ["/data"]
EXPOSE 8000
