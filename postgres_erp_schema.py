...
BASE='\n'.join(_translate(x) for x in (ACCOUNTING_SQLITE_SCHEMA,RETAIL_SQLITE_SCHEMA,ONBOARDING_SQLITE_SCHEMA,OPERATING_MODEL_SQLITE_SCHEMA,MIGRATION_SQLITE_SCHEMA,TAX_VERIFICATION_SQLITE_SCHEMA))
RLS=[]
